...
%% Import BibTeX Database .bib file %%
\usepackage[utf8]{inputenc}
\usepackage{csquotes, xpatch} % recommended
\usepackage{filecontents}

 \usepackage[english]{babel} % this fixes issue of et al.---bable needs to pass english as the language to the aux file
...
\usecolortheme{wolverine} 
 ...
 % Boxes 
 \setbeamercolor{block title}{fg=beamer@UIUCorange,bg=beamer@UIUCblue} 
 \setbeamercolor{block body}{fg=blue,bg=beamer@UIUCgray} 
...
\setbeamercolor{itemize subitem}{fg=beamer@UIUCblue}
\setbeamercolor{itemize subsubitem}{fg=beamer@UIUCblue}
...
\addbibresource{<bibfilenamehere>}

% redefine command for foot cite-makes it smaller
\newrobustcmd*{\footlessfullcite}{\AtNextCite{\renewbibmacro{title}{}\renewbibmacro{in:}{}\renewbibmacro{eng.}{}}\footfullcite}
